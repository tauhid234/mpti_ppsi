...
<head>
    ...
    <title>SAT RESNARKOBA | LAPORAN AKHIR</title>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
         ...
         <div class="animated fadeIn">
            ...
            <div class="row">
            <?php 
            $query = mysqli_query($conn,"SELECT laporan_proses.*, laporan.latitude, laporan.longtitude, laporan.keterangan, laporan.foto_lokasi, surat_tugas.tanggal, surat_tugas.an_tersangka,surat_tugas.jenis_kelamin,surat_tugas.tgl_lahir,surat_tugas.agama,surat_tugas.pendidikan_terakhir,surat_tugas.pekerjaan,surat_tugas.warganegara,surat_tugas.alamat FROM laporan_proses,surat_tugas,laporan WHERE laporan_proses.unit = '$unit' AND laporan_proses.nama_team = '$team' AND surat_tugas.nama_team = '$team' AND laporan.nama_team = '$team' AND laporan_proses.nomer_kasus = surat_tugas.nomer_kasus AND laporan_proses.nomer_kasus = laporan.nomer_kasus AND laporan_proses.status_laporan = 'sudah selesai' AND laporan.proses_laporan = 'selesai' AND surat_tugas.status_tersangka = 'tertangkap'");
            foreach ($query as $q => $value) {
            ?>
                <div class="col-md-6">
                    <div class="card">

                            <strong class="m-4">LOKASI AWAL</strong>
                            <iframe
                            width="100%"
                            height="200"
                           ...
                           <div class="card-body">
                            ...
                            <strong class="m-4">LOKASI PROSES</strong>
                            <iframe
                            width="100%"
                            height="200"
                            frameborder="0" style="border:0"
                        ...
                        <br><br><i class="menu-icon fa fa-map-marker"></i> <?= $value['unit'];?>
                                ...
                                <div class="card-footer">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#fotoproses<?= $value['id'];?>">
                                Foto Lokasi
                                </button>

                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#viewproses<?= $value['id'];?>">
                                Street View
                                </button>

                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#detailproses<?= $value['id'];?>">
                                Detail
                                </button>
                            </div>

                                <!-- Modal -->
                                <div class="modal fade" id="fotoproses<?= $value['id'];?>" tabindex="-1" aria-labelledby="<?= $value['id'];?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="<?= $value['id'];?>">Foto Lokasi</h5>
                                 ...
                                 <!-- Modal -->
                                 <div class="modal fade" id="viewproses<?= $value['id'];?>" tabindex="-1" aria-labelledby="<?= $value['id'];?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="<?= $value['id'];?>">Street View</h5>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="detailproses<?= $value['id'];?>" tabindex="-1" aria-labelledby="<?= $value['id'];?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
